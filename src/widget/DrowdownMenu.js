...
export default class DropdownMenu extends Component {
  ...
  constructor(props, context) {
    ...
    this.defaultConfig = {
      ...
      tintColor: 'white',
      selectItemColor: "red",
      arrowImg: '../images/dropdown/dropdown_arrow.png',
      checkImage: '../images/dropdown/menu_check.png'
    };
  ...
  renderChcek(index, title) {
    ...
    if (this.state.selectIndex[activityIndex] == index) {
      var checkImage = this.props.checkImage ? this.props.checkImage : require('../images/dropdown/menu_check.png');
      return (
  ...
  renderDropDownArrow(index) {
    var icon = this.props.arrowImg ? this.props.arrowImg : require('../images/dropdown/dropdown_arrow.png');
  ...
  render() {
    ...
    return (
      <View style={[this.props.style, {flexDirection: 'column', justifyContent: 'flex-start'}]} >
